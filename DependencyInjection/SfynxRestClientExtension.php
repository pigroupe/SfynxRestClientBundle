 ...
 */
class SfynxRestClientExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config['api'] as $apiName => $apiConfiguration) {
            ...
            $implementorId = sprintf('sfynx_rest_client.api_implementor.%s', $apiName);
            $container->setDefinition($implementorId, $implementorDefinition);
            $implementorDefinition->addTag('sfynx_rest_client.api_implementor');
            ...
            $serviceDefinition->addMethodCall('setLogger', array(
                new Reference('sfynx_rest_client.http_logger')
            ));

            $serviceDefinition->addTag('sfynx_rest_client.api', array('name' => $apiName));
            $container->setDefinition(
                sprintf('sfynx_rest_client.api.%s', $apiName),
                $serviceDefinition
            );
        }
    }
