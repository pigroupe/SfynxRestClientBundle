...
use Sfynx\AuthCommonBundle\Security\AuthorizationRefresherInterface;
...
interface RestApiClientImplementorInterface extends RestApiClientInterface
{
    ...
    /**
     * Set the circuit breaker service name
     *
     * @param string $serviceName
     */
    public function setCircuitBreakerName($serviceName);

    /**
     * @return string The circuit breaker service name
     */
    public function getCircuitBreakerName();
